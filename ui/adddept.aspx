<%@ Page Language="vb" AutoEventWireup="false" Inherits="MSLTimesheet.AddDept" CodeFile="AddDept.aspx.vb" %>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			...
			<asp:label id="Label4" style="Z-INDEX: 110; LEFT: 16px; POSITION: absolute; TOP: 24px" runat="server"
				Font-Size="8pt" Font-Names="Tahoma" Width="136px" Font-Bold="True" Font-Underline="True">Add Department</asp:label>
